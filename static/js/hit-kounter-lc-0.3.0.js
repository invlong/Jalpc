...
function(e) {
			...
			request: function() {
				...
				case "hk.page.increment":
					s.url = s.url || l, s.title = s.title || document.title, p.equalTo("url", s.url), p.find()["try"](function(e) {
						...
						if (t) {
							for (var n = 0, r = t.length; r > n; n++) if (t[n].url === e.url) {
								t[n].count = e.count;
								break
							}
	...
	e.exports = function(e) {
		...
		return function(e, a, o) {
			n.push('<h3 class="hit-kounter-top-title">��վ������ Top ' + r.escape(null == (t = e) ? "" : t) + '</h3><table class="hit-kounter-top-table">'), function() {
				var e = a;
				if ("number" == typeof e.length) for (var o = 0, i = e.length; i > o; o++) {
					var u = e[o];
